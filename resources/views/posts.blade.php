...
<body class="h-full">
    <x-layout>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:pt-16 lg:pb-8 lg:px-6">
        ...
        <div class="container mx-auto px-4 xl:px-40">
            <div class="flex flex-wrap -mx-4">
                <div class="pt-4 pb-2 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
                    <div class="grid gap-8 lg:grid-cols-3 md:grid-cols-2">
                        ...
                        @empty
                            <div class="w-full flex justify-center text-center py-8">
                                <h1 class="font-semibold text-lg">Article Not Found!</h1>
                            </div>
                        @endforelse
                    </div>
                </div>
